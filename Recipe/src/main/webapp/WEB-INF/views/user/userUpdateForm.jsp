	...
	<div id="changePwdModal" class="modal">
		<form id="pwdFrm" action="updatePwd.do" onsubmit="return pwdCheck()"
			...
			<div class="modal-content">
				<span class="close">&times;</span> <label for="oldPwd"><b>기존
						패스워드 입력</b></label> <input id="oldPwd" type="password"
					placeholder="기존 패스워드를 입력하세요." required="required"> <label
					for="newPwd1"><b>새 패스워드 입력</b></label> <input id="newpwd1"
					type="password" placeholder="새 패스워드를 입력해주세요." name="userPassword"
					required="required"> <label for="newPwd2"><b>새
						패스워드 확인</b></label> <input id="newpwd2" type="password"
					placeholder="새 패스워드를 확인해주세요." required="required">

				<div align="center">
					<button type="submit">비밀번호 변경하기</button>
					<button type="button"
						onclick="document.getElementById('changePwdModal').style.display='none'">취소하기</button>
				</div>
			</div>
		</form>
	</div>
